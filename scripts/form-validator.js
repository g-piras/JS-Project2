...
// /**
//  * This function check if the data submitted is valid
//  */
// function validate() {
//     let error = document.querySelector("span.error-message");
...
//         let dateToCheck = new Date(startDate.value);
//         if (dateToCheck < today) {
//             let span = document.createElement("span");
//             span.textContent = "Only future dates allowed";
//             span.className = "error-message";
//             document.querySelector("label[for='start-date']").after(span);
//             empty = true;
//         }
//         else {
//             empty = false;
...
//     //check all numeric data
//     let numericData = [
//         document.getElementById("days-to-wait"),
//         document.getElementById("weeks"),
//         document.getElementById("items-per-week"),
//         document.getElementById("item-week-life")
//     ];
//     let numericRegEx = /^[0-9]*$/;

//     let errorMessage = "Only numbers are allowed";
//     let spanError = document.createElement("span");
//     spanError.textContent = errorMessage;
//     spanError.className = "error-message";

//     if (!numericData.some(element => element.value === "")) {
//         empty = true;
//         numericData.forEach((data) => {
//             if (!numericRegEx.test(parseInt(data.value))) {
//                 console.log(typeof data.value);
//                 data.before(spanError);
//             }
//         });
//     }
//     else {
